...
export default {
  data() {
    return {
      avatarUrl: "http://192.168.0.116:5000/api/emotion/4.jpg", // 藿藿头像图片，默认为中性情绪
      defaultAvatarUrl: "http://192.168.0.116:5000/api/emotion/5.jpg", // 默认头像
    ...
    handleWebSocketMessage(data) {
      ...
      switch (data.type) {
        ...
        case "assistant_reply":
          ...
          // 更新头像情绪图片
          if (data.emotion_img) {
            this.avatarUrl = `http://192.168.0.116:5000${data.emotion_img}`;
          ...
          if (data.audio_url && data.message && data.message.trim()) {
            this.playAudio(`http://192.168.0.116:5000${data.audio_url}`);
